...
for leaveoutfile in os.listdir(path_of_dir):
    print(leaveoutfile)
    ...
    # Score the leave out TCR-p structure
    leave_out_ab = find_tcr_p_interactions(leaveoutfile)
...
plt.title('Leave one out peptide scorings', fontsize = 20)
fig.savefig("Leave_one_out_scorings.png")